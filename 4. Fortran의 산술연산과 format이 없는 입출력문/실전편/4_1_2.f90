! format이 없는 입출력문
! 세 점수를 입력 받아 평균과 최댓값, 최솟값을 출력하는 프로그램을 작성해봅시다!
...
! 이번에는 최고점, 최저점도 함께 구하고자 하므로 각각을 담을 변수인 max_score, min_Score을 생성하고 real로 선언합니다.
real:: score1, score2, score3, mean, max_score, min_score
